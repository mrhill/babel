...
bbERR bbArr_SetSize52(void* const p, const bbUINT size);
...
void* bbArr_Grow52(void* const p, const int relsize);
...
bbERR bbArr_CopyFrom52(void* const p, void* const pFrom);
