...
bbERR bbArr_SetSize56(void* const p, const bbUINT size) { return bbArr_SetSize<56>(p, size); }
...
void* bbArr_Grow56(void* const p, const int relsize) { return bbArr_Grow<56>(p, relsize); }
...
bbERR bbArr_CopyFrom56(void* const p, void* const pFrom) { return bbArr_CopyFrom<56>(p, pFrom);}
